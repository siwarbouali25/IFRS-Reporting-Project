...
from generation_engine.graph.workflow import (
    run_ifrs_report_graph,
)
...
def run_real_report_generation_job(job_id: str):
    ...
    try:
        ...
        final_state = run_ifrs_report_graph(
            initial_state
        )
        ...
        save_json_artifact(
            ...
            report_version=version,
            artifact_type=(
                ReportArtifact.ArtifactType.LOG
            ),
            object_key=(
                f"{base_key}/handoff_manifest.json"
            ),
