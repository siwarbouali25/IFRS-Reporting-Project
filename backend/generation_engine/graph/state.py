...
class IFRSReportGraphState(TypedDict, total=False):
    ...
    # Direct local path of the payload bundle generated by
    # the data-preparation pipeline.
    payload_dir: str

    # These remain relative to GENERATION_INPUT_ROOT while
    # IFRS and style assets are still stored locally.
