...
def build_ifrs_report_graph():
    ...
    graph.add_node("build_evidence_maps", build_evidence_maps_node)
    graph.add_node(
        "build_coverage_and_missing",
        build_coverage_and_missing_node,
    )
    ...
    graph.add_edge("load_inputs", "build_evidence_maps")
    graph.add_edge("build_evidence_maps", "build_coverage_and_missing")
    graph.add_edge("build_coverage_and_missing", "build_disclosure_plans")
